...
#
# Same chatbot as Part2, but configured from environment variables instead of
# config.ini, because a container image must not contain your settings or keys.
...
## Configuration passed in by ECS at run time
...
## Credentials come from the task role attached to the container
...
def main():
    ...
    ## The chat history lives in this task's memory (see the scaling exercise)
